...
const GetApp = () => {
  return (
    <section className="flexCenter w-full flex-col" id="downloads">
      <div
        className="max-container relative flex w-full flex-col justify-between 
    gap-32 overflow-hidden px-6 py-12 sm:flex-row sm:gap-12 sm:py-24 lg:px-20
     xl:max-h-[598px] 2xl:rounded-5xl"
      >
        <div
          className="z-20 flex w-full flex-1 flex-col items-start justify-center 
        ...
        >
          ...
          <p>
            ...
            in non eligendi temporibus repellat eos dolore. Accusantium,
            similique excepturi.
          </p>
